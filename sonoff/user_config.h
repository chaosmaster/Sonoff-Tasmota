...
#define MODULE                 TUYA_DIMMER       // [Module] Select default model from sonoff_template.h (Should not be changed)
...
// -- Ota -----------------------------------------
#define OTA_URL                "http://chaosv.de/tuya/sonoff.bin"  // [OtaUrl]
